...
export default function VehicleIncidentsPage() {
  return (
    <div className="space-y-6">
      <div>
        <p className="text-xs uppercase tracking-[0.3em] text-muted-foreground">Incidenti</p>
      ...
      <Card className="border-border bg-card p-6">
        <div className="space-y-3 text-sm text-muted-foreground">
          {incidents.map((incident) => (
            <div key={incident.title} className="flex flex-col gap-2 border-b border-border pb-3 last:border-b-0 last:pb-0 md:flex-row md:items-center md:justify-between">
              <div>
